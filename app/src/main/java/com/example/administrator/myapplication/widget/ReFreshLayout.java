...
public class ReFreshLayout extends ViewGroup {
    ...
    private void createProgressView() {
        v_top = new CircleImageView(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER / 2);
        mProgress = new MaterialProgressDrawable(getContext(), this);
        mProgress.setBackgroundColor(CIRCLE_BG_LIGHT);
        v_top.setImageDrawable(mProgress);
        addView(v_top);
...
//            postInvalidate();
    ...
    private class DefaultDragHelper extends ViewDragHelper.Callback {
        ...
        public int clampViewPositionVertical(View child, int top, int dy) {
            ...
            final int topBound = getPaddingTop() - viewHeight;
            final int bottomBound = v_top.getPaddingBottom();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        viewMaxHeight = view_bg.getMeasuredHeight();
        mTop = -viewMaxHeight;
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        v_top.layout(0, mTop, r, mTop + v_top.getMeasuredHeight());
